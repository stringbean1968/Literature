\chapter{Roles, Responsibilities and Governance in a Veterinary Practice}
\label{chap:Roles, Responsibilities and Governance in a Veterinary Practice}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses how governance roles distribute accountability so that risk controls are owned, monitored and escalated rather than assumed. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: RCVS Code and PSS governance expectations; HSWA 1974 responsibilities on employers and employees; IRR17 appointment duties for radiation roles where applicable.}
...
\barquote{In Chapter~\ref{chap:Anaesthesia and Sedation Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
