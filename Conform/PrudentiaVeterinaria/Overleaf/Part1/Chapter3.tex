\chapter{The Five-Step Risk Assessment Method Applied to a Veterinary Setting}
\label{chap:The Five-Step Risk Assessment Method Applied to a Veterinary Setting}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses how the Prudentia five-step methodology translates directly into clinic workflows, theatre lists, dispensary controls and ambulatory services. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Management of Health and Safety at Work Regulations 1999; COSHH 2002; RCVS Code; RCVS PSS quality improvement expectations.}
...
\paragraph{This assessment should run on a trigger-plus-schedule basis with a minimum formal review cadence of annually. Unscheduled review should be triggered by service changes, staffing changes, equipment/medicine changes, incidents or near misses, and material legal or guidance updates.}
...
\barquote{In Chapter~\ref{chap:Roles, Responsibilities and Governance in a Veterinary Practice}, we turn from this assessment to the next domain in the Prudentia framework.}
