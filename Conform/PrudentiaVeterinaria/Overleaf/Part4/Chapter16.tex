\chapter{Sharps, Needlestick, Bite and Scratch Injury Risk Assessment}
\label{chap:Sharps, Needlestick, Bite and Scratch Injury Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses injury pathways with blood-borne, chemical and physical consequences for veterinary staff. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: HSWA 1974; Sharps Instruments in Healthcare Regulations 2013 where applicable; RIDDOR; COSHH and local post-exposure policy.}
...
\barquote{In Chapter~\ref{chap:Manual Handling, Patient Restraint and Lifting Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
