\chapter{Ionising and Non-Ionising Radiation Risk Assessment}
\label{chap:Ionising and Non-Ionising Radiation Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses the broader radiation profile including lasers, UV and MRI hazards in addition to X-ray systems. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: IRR17; laser safety standards and guidance; MRI safety principles where installed; HSWA 1974.}
...
\barquote{In Chapter~\ref{chap:Anaesthetic Gas Scavenging and Workplace Exposure Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
