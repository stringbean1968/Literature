\chapter{General Workplace H\&S Risk Assessment for a Veterinary Practice}
\label{chap:General Workplace H and S Risk Assessment for a Veterinary Practice}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses the core duty to identify and control workplace hazards across all areas of a clinic or hospital. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: HSWA 1974; Management of Health and Safety at Work Regulations 1999; Workplace (Health, Safety and Welfare) Regulations 1992.}
...
\barquote{In Chapter~\ref{chap:Biological Hazards and Zoonoses Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
