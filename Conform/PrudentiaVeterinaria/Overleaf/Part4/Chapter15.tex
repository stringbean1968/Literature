\chapter{Biological Hazards and Zoonoses Risk Assessment}
\label{chap:Biological Hazards and Zoonoses Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses exposure control for zoonotic disease across consult rooms, kennels, farm calls, laboratory areas and waste streams. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: COSHH biological agents provisions; RIDDOR disease reporting requirements; public health and APHA guidance; vaccination and occupational health policy.}
...
\barquote{In Chapter~\ref{chap:Sharps, Needlestick, Bite and Scratch Injury Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
