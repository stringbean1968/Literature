\chapter{Anaesthetic Gas Scavenging and Workplace Exposure Risk Assessment}
\label{chap:Anaesthetic Gas Scavenging and Workplace Exposure Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses chronic exposure prevention for inhalational anaesthetic agents through equipment and ventilation controls. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: COSHH 2002 including Regulation 9 examination of controls; HSWA 1974; occupational exposure guidance for volatile anaesthetics and nitrous oxide.}
...
\barquote{In Chapter~\ref{chap:Fire Safety Risk Assessment for Veterinary Premises}, we turn from this assessment to the next domain in the Prudentia framework.}
