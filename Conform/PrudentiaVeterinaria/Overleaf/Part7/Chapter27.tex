\chapter{Data Protection, Clinical Records and Cyber Risk Assessment}
\label{chap:Data Protection, Clinical Records and Cyber Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses information governance risks across clinical systems, telemedicine, cloud services and cyber threats. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: UK GDPR; Data Protection Act 2018; RCVS record-keeping expectations; cyber security guidance from NCSC and insurers.}
...
\barquote{In Chapter~\ref{chap:Financial, Insurance, Indemnity and Business Continuity Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
