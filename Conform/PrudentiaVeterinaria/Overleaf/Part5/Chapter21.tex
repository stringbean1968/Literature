\chapter{Infection Prevention, Biosecurity and Practice Hygiene Risk Assessment}
\label{chap:Infection Prevention, Biosecurity and Practice Hygiene Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses practice-wide controls to prevent transmission between patients, teams, equipment and environments. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: RCVS Code and PSS IPC expectations; COSHH; APHA/DEFRA notifiable disease pathways; sector guidance for companion, equine and farm practice.}
...
\barquote{In Chapter~\ref{chap:Clinical and Hazardous Waste Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
