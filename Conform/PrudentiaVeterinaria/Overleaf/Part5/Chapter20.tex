\chapter{Fire Safety Risk Assessment for Veterinary Premises}
\label{chap:Fire Safety Risk Assessment for Veterinary Premises}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses fire and evacuation risks unique to veterinary premises with inpatients, oxygen, chemicals and OOH occupancy. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Regulatory Reform (Fire Safety) Order 2005; Fire (Scotland) Act 2005 where applicable; DSEAR principles for flammables where relevant.}
...
\barquote{In Chapter~\ref{chap:Infection Prevention, Biosecurity and Practice Hygiene Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
