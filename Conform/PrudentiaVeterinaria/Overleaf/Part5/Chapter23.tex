\chapter{Equipment, Autoclaves and Pressure Systems Risk Assessment}
\label{chap:Equipment, Autoclaves and Pressure Systems Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses equipment safety and reliability across sterilisation, anaesthetic delivery and patient handling systems. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: PUWER 1998; LOLER 1998; Pressure Systems Safety Regulations 2000; electrical safety and manufacturer instructions.}
...
\barquote{In Chapter~\ref{chap:Lone Working, Ambulatory and Equine/Farm-Visit Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
