\chapter{Clinical and Hazardous Waste Risk Assessment}
\label{chap:Clinical and Hazardous Waste Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses segregation, storage and disposal risks for sharps, pharmaceuticals, anatomical material and cytotoxic streams. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Hazardous Waste Regulations 2005; waste duty-of-care requirements; Animal By-Products legislation; environmental permitting and carrier licensing.}
...
\barquote{In Chapter~\ref{chap:Equipment, Autoclaves and Pressure Systems Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
