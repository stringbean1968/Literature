\chapter{Veterinary Medicines Risk Assessment}
\label{chap:Veterinary Medicines Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses the lifecycle of medicine governance from prescribing under care through storage, dispensing, records and reconciliation. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Veterinary Medicines Regulations 2013; VMD guidance; RCVS Code and Under Care guidance; food-chain medicine withdrawal obligations.}
...
\barquote{In Chapter~\ref{chap:Controlled Drugs Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
