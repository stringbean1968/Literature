\chapter{Controlled Drugs Risk Assessment}
\label{chap:Controlled Drugs Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses governance of controlled drugs against diversion, error and regulatory non-compliance. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Misuse of Drugs Act 1971; Misuse of Drugs Regulations 2001; Veterinary Medicines Regulations 2013; Home Office and VMD expectations.}
...
\barquote{In Chapter~\ref{chap:Cytotoxic, Hormonal and Hazardous Medicines Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
