\chapter{Cytotoxic, Hormonal and Hazardous Medicines Risk Assessment}
\label{chap:Cytotoxic, Hormonal and Hazardous Medicines Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses occupational and environmental controls for high-hazard medicines including chemotherapy and hormonal products. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: COSHH 2002; Hazardous waste requirements; HSWA 1974; relevant VMD and specialist guidance for hazardous veterinary medicines.}
...
\barquote{In Chapter~\ref{chap:General Workplace H and S Risk Assessment for a Veterinary Practice}, we turn from this assessment to the next domain in the Prudentia framework.}
