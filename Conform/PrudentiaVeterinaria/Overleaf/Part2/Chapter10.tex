\chapter{Euthanasia and End-of-Life Risk Assessment}
\label{chap:Euthanasia and End-of-Life Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses clinical, ethical and psychological risks around euthanasia decisions, drug handling and post-procedure pathways. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Veterinary Medicines Regulations 2013; Misuse of Drugs Regulations 2001; Animal By-Products legislation; RCVS Code and professional ethics guidance.}
...
\barquote{In Chapter~\ref{chap:Veterinary Medicines Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
