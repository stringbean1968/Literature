\chapter{Hospitalisation, Critical Care and Out-of-Hours Risk Assessment}
\label{chap:Hospitalisation, Critical Care and Out-of-Hours Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses risks associated with inpatient monitoring, escalation, staffing levels and handover quality across day and OOH periods. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: RCVS Code; RCVS PSS and OOH expectations; HSWA 1974; medicine and oxygen safety requirements.}
...
\barquote{In Chapter~\ref{chap:Euthanasia and End-of-Life Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
