\chapter{Surgical Risk Assessment}
\label{chap:Surgical Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses how surgical risk assessment integrates patient status, procedure complexity, team competence, asepsis and checklist discipline. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: RCVS Code; RCVS PSS standards for theatre and governance; HSWA 1974; infection prevention guidance and local policy standards.}
...
\barquote{In Chapter~\ref{chap:Diagnostic Imaging Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
