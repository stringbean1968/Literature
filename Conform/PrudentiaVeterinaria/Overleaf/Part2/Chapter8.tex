\chapter{In-house Laboratory and Point-of-Care Diagnostics Risk Assessment}
\label{chap:In-house Laboratory and Point-of-Care Diagnostics Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses biological, chemical and equipment risks in rapid diagnostics that support same-day clinical decisions. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: COSHH 2002; HSWA 1974; PUWER 1998; waste and sharps obligations; RCVS PSS laboratory governance expectations.}
...
\barquote{In Chapter~\ref{chap:Hospitalisation, Critical Care and Out-of-Hours Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
