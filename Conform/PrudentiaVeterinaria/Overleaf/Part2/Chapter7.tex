\chapter{Diagnostic Imaging Risk Assessment}
\label{chap:Diagnostic Imaging Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses the safe governance of radiography, fluoroscopy and CT, balancing diagnostic benefit with radiation exposure controls. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Ionising Radiations Regulations 2017 (IRR17); Ionising Radiation (Medical Exposure) Regulations 2017 where applicable; HSE guidance; RPA and RPS governance.}
...
\barquote{In Chapter~\ref{chap:In-house Laboratory and Point-of-Care Diagnostics Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
