\chapter{Anaesthesia and Sedation Risk Assessment}
\label{chap:Anaesthesia and Sedation Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses the peri-anaesthetic pathway where patient-specific risk, drug selection, equipment reliability and recovery planning determine outcomes. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: RCVS Code; Veterinary Medicines Regulations 2013; Misuse of Drugs Regulations 2001 where controlled medicines are used; AVA guidance; HSWA duties for staff exposure.}
...
\barquote{In Chapter~\ref{chap:Surgical Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
