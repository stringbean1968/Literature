\chapter{Animal Welfare and Ethical Risk Assessment}
\label{chap:Animal Welfare and Ethical Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses ethical and welfare decision-making for complex cases where legal compliance and moral judgement intersect. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Animal Welfare Act 2006 and devolved statutes; Veterinary Surgeons Act 1966; RCVS Code and ethics guidance; ASPA 1986 where teaching/research applies.}
...
\barquote{In Chapter~\ref{chap:Building a Risk-Mature Veterinary Practice — Audit, Cadence and Continuous Improvement}, we turn from this assessment to the next domain in the Prudentia framework.}
