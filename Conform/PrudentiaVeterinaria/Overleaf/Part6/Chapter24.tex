\chapter{Lone Working, Ambulatory and Equine/Farm-Visit Risk Assessment}
\label{chap:Lone Working, Ambulatory and Equine/Farm-Visit Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses dynamic risk controls for off-site work, travel, unfamiliar environments and large-animal handling. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: HSWA 1974; Management Regulations 1999; road travel and lone-worker policy standards; farm and equine safety guidance.}
...
\barquote{In Chapter~\ref{chap:Workforce Wellbeing — Stress, Burnout, Compassion Fatigue and Suicide Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
