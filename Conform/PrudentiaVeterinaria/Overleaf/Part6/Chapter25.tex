\chapter{Workforce Wellbeing — Stress, Burnout, Compassion Fatigue and Suicide Risk Assessment}
\label{chap:Workforce Wellbeing — Stress, Burnout, Compassion Fatigue and Suicide Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses psychological risk management within a profession known for high emotional load and exposure to distressing events. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: HSWA 1974; Management Regulations 1999; HSE Management Standards for stress; RCVS Mind Matters and Vetlife support frameworks.}
...
\barquote{In Chapter~\ref{chap:Aggressive Animals, Difficult Clients and Violence at Work Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
