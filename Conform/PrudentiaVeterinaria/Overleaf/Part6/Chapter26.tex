\chapter{Aggressive Animals, Difficult Clients and Violence at Work Risk Assessment}
\label{chap:Aggressive Animals, Difficult Clients and Violence at Work Risk Assessment}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses controls for behavioural escalation involving both patients and members of the public. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: HSWA 1974; Management Regulations 1999; criminal law protections; RCVS guidance on professional boundaries and declining care in limited circumstances.}
...
\barquote{In Chapter~\ref{chap:Data Protection, Clinical Records and Cyber Risk Assessment}, we turn from this assessment to the next domain in the Prudentia framework.}
