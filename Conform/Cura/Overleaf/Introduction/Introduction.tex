...
\paragraph{\textit{Cura} is written as the sister volume to \textit{Prudentia}. The method is the same, the discipline is the same, and the practical objective is the same: to help a professional team identify risk early, assess it proportionately, and implement controls that can be evidenced under scrutiny. What changes in this volume is context. Here, the working environment is the veterinary profession, where clinical judgement, animal welfare, legal duty, emotional labour, and commercial sustainability interact every day.}
...
\paragraph{\textit{Cura} is UK-centred. It references the Veterinary Surgeons Act 1966, the RCVS Code, RCVS PSS standards, the Veterinary Medicines Regulations, health and safety law, COSHH, radiation controls, fire safety law, and data protection law.}
...
%---------------------------- SECTION ----------------------------
\section{How to use Cura in governance}
