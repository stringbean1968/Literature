\chapter{What is Risk in a Veterinary Context?}
\label{chap:What is Risk in a Veterinary Context?}

%---------------------------- SECTION ----------------------------
\section{Why this assessment matters in veterinary practice}

\paragraph{This chapter addresses what and why veterinary risk assessment matters across patient safety, welfare outcomes, client trust, regulatory obligations and financial resilience. In a veterinary setting, risk cannot be reduced to one dimension. Clinical outcomes, animal welfare, staff safety, legal compliance, data quality, and commercial continuity are interdependent. A weakness in one area can migrate quickly into the others.}
...
\paragraph{Key frameworks relevant to this chapter include: Veterinary Surgeons Act 1966; RCVS Code of Professional Conduct; RCVS Practice Standards Scheme (PSS); Health and Safety at Work etc. Act 1974; Animal Welfare Act 2006 and devolved equivalents.}
...
\barquote{In Chapter~\ref{chap:The Regulatory and Professional Framework}, we turn from this assessment to the next domain in the Cura framework.}
